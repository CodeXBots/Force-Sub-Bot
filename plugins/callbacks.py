...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                   InlineKeyboardButton("🧑‍💻  ᴏᴡɴᴇʀ", url="https://telegram.me/RahulReviewsYT"),
                    InlineKeyboardButton("♻️  ʜᴇʟᴘ", callback_data="help_data")
                ]
            ]
        )
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("ɴᴇxᴛ", callback_data="about_data")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "ʀᴇᴘᴏꜱɪᴛᴏʀʏ", url="https://github.com/CodeXBots/Filter-Bot")
                ],
                [
